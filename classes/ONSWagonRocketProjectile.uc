...
//
//-----------------------------------------------------------
class ONSWagonRocketProjectile extends Projectile;
...
defaultproperties
{
     ...
     MyDamageType=Onslaught.DamTypeTankShell
     ExplosionDecal=HellWagon.ONSWagonRocketScorch
     DrawType=DT_StaticMesh
     StaticMesh=WeaponStaticMesh.RocketProj
     AmbientSound=VMVehicleSounds-S.HoverTank.IncomingShell
     LifeSpan=1.200000
     AmbientGlow=96
